              ...
              <div className="title-area">
                ...
                >
                  ...
                  >
                    <div className="relative z-10 flex flex-col space-y-5">
                      ...
                      <div>
                        ...
                        Delivering actionable insights using Artificial Intelligence and Machine Learning.
                        </p>
                      </div>
                    </div>
                  ...
                  >
                    <div className="relative z-10 flex flex-col space-y-5">
                      ...
                      <div>
                        ...
                        <p className="text-paragraph">
                        Leveraging geospatial technologies and remote sensing for precise and efficient resource management.
                        </p>
                      </div>
                    </div>
                    <div className="absolute top-0 left-0 w-full h-full transition-all duration-300 ease-in-out opacity-0 group-hover:opacity-100">
                  ...
                  >
                    <div className="relative z-10 flex flex-col space-y-5">
                      ...
                      <div>
                        ...
                        <p className="text-paragraph">
                        Harnessing Quantum Computing to tackle large-scale, data-intensive problems with unparalleled efficiency.
                        </p>
                      </div>
                    </div>
                    <div className="absolute top-0 left-0 w-full h-full transition-all duration-300 ease-in-out opacity-0 group-hover:opacity-100">
                  ...
                  >
                    <div className="relative z-10 flex flex-col space-y-5">
                      <div className="flex items-center justify-center w-10 h-10 bg-white border-2 rounded-full border-purple">
                        <span className="font-semibold text-purple">04</span>
                      </div>
                      <div>
                        <p className="mb-4 font-semibold text-20 text-main-black">
                        ...
                        <p className="text-paragraph">
                        Tailored solutions to meet the specific needs of government agencies and private sectors.
                        </p>
                      </div>
                    </div>
                    <div className="absolute top-0 left-0 w-full h-full transition-all duration-300 ease-in-out opacity-0 group-hover:opacity-100">
                ...
                <div className="right-0 h-full xl:absolute">
                  <div className="sticky top-[155px]">
                    ...
                    <div id="progressThumbHeight">
                      <img
                        src="/assets/images/OurSolution.png"
                        alt=""
                      />
                    </div>
                  </div>
