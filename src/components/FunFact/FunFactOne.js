        ...
        <div className="mx-auto theme-container">
          <div className="grid xl:grid-cols-2 grid-cols-1 xl:gap-[155px]">
            <div className="w-full">
              ...
              At Deeptronix Sdn Bhd, we are dedicated to solving complex challenges through innovative and impactful solutions. Our expertise lies in integrating advanced technologies with diverse datasets to empower industries and drive growth.
