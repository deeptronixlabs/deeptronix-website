            ...
            <div className="w-full grid xl:grid-cols-3 md:grid-cols-2 grid-cols-1 xl:gap-[70px] gap-8">
              ...
              >
                ...
                <div>
                  ...
                  Offering advanced applications and analysis, from Machine Learning to Deep Learning and Quantum Artificial Intelligence, tailored to solve diverse customer challenges.
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-center text-paragraph">
                  Utilizing cutting-edge airborne, spaceborne, optical, radar, and microwave platforms for reliable data acquisition and analysis, mineral exploration, and national defense.
                  </p>
                </div>
              </div>
              <div
              ...
              >
                ...
                <div>
                  <p className="mb-4 font-semibold text-center text-20 text-main-black">
                  Integrated AI and GIS Solutions
                  </p>
                  <p className="text-center text-paragraph">
                  Combining AI techniques with GIS and data analytics to deliver specialized, accurate, and impactful solutions that meet precise customer requirements.
                  </p>
                </div>
              </div>
              <div
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-center text-paragraph">
                  Leveraging the limitless potential of Quantum Computing to address complex big data challenges, enabling faster, more robust solutions to advanced business questions.
                  </p>
                </div>
              </div>
              <div
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-center text-paragraph">
                  Aiming to lead the nation in AI solutions and establishing a global presence as a powerhouse of technological innovation.
                  </p>
                </div>
              </div>
              <div
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-center text-paragraph">
                  Providing fully customizable AI and remote sensing solutions designed to be both innovative and budget-friendly.
                  </p>
                </div>
              </div>
            </div>
